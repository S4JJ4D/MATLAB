...
%#codegen
    ...
    methods
        ...
        %   collisionBox, collisionCapsule, collisionCylinder, collisionSphere,
        %   or collisionMesh. This function uses the Pose property of the
        %   COLLISIONOBJ to transform the vertices into the rigid body frame.
        %
