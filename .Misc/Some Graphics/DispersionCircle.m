function objects_vec = DispersionCircle(ax, Ri, Ro, N, circle_center, options)
...
vector_toward_center = discrete_points_out - discrete_points_in ;
...
for i=1:arrows_count
    ...
    objects_vec(3+i) = ...
        quiver(ax, discrete_points_in(1,:), discrete_points_in(2,:), ...
