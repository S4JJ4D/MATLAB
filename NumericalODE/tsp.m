...
%   enabled, the last column of F is used for LTE estimation.
%
...
%
%   TSP(..., 'ReportGE', true) reports global error in the output. This
%   options is only effective when an exact solution is available.
%
%   TSP(..., 'ReportLTE', true) also reports local truncation error in the
%   output. This option is only effective when an exact solution is
%   available.
%
%   REST=TSP(...) returns the approximation points generated by the
%   numerical method in a tabulated form.
%
%   [REST,XP_SEQ]=TSP(...) also returns the approximations for the
