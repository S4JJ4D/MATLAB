classdef DynamicSpring < handle
    ...
    %   described by the following set of equations: (t is an independent
    %   parameter)
    ...
    properties (SetAccess = private)
        ...
        configuration (1,3) double {mustBeReal}
    end
    ...
    methods
        ...
        function PlotSpring(obj, total_length, options)
            arguments
                ...
                options.Configuration % consists of anchor point and orientation
            end
            ...
            % 'makehgtform' is slow. Directly assign the ht matrix:
            hg.Matrix = ...
